...
# use_python("C:/Program Files/Python36", required = TRUE)
# use_python("C:/Users/blake/anaconda3/Python 3.8.3")
# C:\Users\blake\anaconda3\python.exe

path_to_python <- "C:/Users/blake/anaconda3/python.exe"
...
beautiful <- import('BeautifulSoup')
